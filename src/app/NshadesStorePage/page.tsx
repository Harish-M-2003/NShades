    ...
    return (
        <div className=" p-5 h-screen">
            <div className="w-full flex rounded-2xl h-full">
                <div className="bg-white max-md:p-10 w-full w-[65rem] pl-10">
                ...
                <div className="w-full hidden md:block">
                    ...
                    {/* <img src={NShadesSignUpPage} className="transform scale-x-[-1]"/>
                     */}
                     <Image alt = {"ImageError"} src = {NShadesSignUpPage}/>
                </div>
            </div>
        </div>
    );
