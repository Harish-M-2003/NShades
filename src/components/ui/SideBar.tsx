...
export default function SideBar({page}){
    ...
    const options = [
        ...
        {icon : <RxDashboard/> , name : "Categories" , optionlist : [] },

        {icon : <AiOutlineUser/> , name : "Admins" , optionlist : [] },

        {icon : <LuSettings/> , name : "Settings" , optionlist : [{icon : <HiOutlineShoppingBag/> , name : "Edit Page"}] },
